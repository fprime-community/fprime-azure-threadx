...
enum {
    FATAL_EVENT_CB_DEPTH = 2, //!< FATAL event circular buffer depth
    ...
    ACTIVITY_LO_EVENT_CB_DEPTH = 10, //!< ACTIVITY LO circular buffer depth
    DIAGNOSTIC_EVENT_CB_DEPTH = 10, //!< DIAGNOSTIC event circular buffer depth

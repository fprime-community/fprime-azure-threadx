...
#include "../NucleoBlink_Top/NucleoSchedContexts.hpp"
...
static NATIVE_UINT_TYPE rg10HzContext[] = {Nucleo::CONTEXT_RPI_DEMO_10Hz, 0, 0, 0};
Svc::ActiveRateGroupImpl rateGroup10HzComp(FW_OPTIONAL_NAME("RG10Hz"),rg10HzContext,FW_NUM_ARRAY_ELEMENTS(rg10HzContext));
static NATIVE_UINT_TYPE rg1HzContext[] = {0, 0, Nucleo::CONTEXT_RPI_DEMO_1Hz, 0};
...
// Nucleo specific components
Nucleo::LedBlinkerComponentImpl ledBlinker(FW_OPTIONAL_NAME("LedBlinker"));
Nucleo::HardwareRateDriver hardwareRateDriver(FW_OPTIONAL_NAME("HardDriver"), 100);
Nucleo::SerialDriverComponentImpl comm(FW_OPTIONAL_NAME("Comm"), 1);
Svc::NucleoTimeImpl nucleoTime(FW_OPTIONAL_NAME("Time"));

//TODO: Replace by non-baremetal version of task runner...if required
 ...
 * not needed for Nucleo projects, as they run forever, however; it is here
 * for completeness.
 */
void exitTasks(void) {

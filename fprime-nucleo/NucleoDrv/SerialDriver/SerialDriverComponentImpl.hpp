...
#include "Os/Task.hpp"
#include "fprime-nucleo/NucleoDrv/SerialDriver/SerialDriverComponentAc.hpp"
...
//Allow for setting serial ports from the inputs
    ...
    public SerialDriverComponentBase
  {
    ...
    public:
      const static NATIVE_UINT_TYPE SERIAL_BUFFER_SIZE = 64; // Maximum Nucleo Serial buffer size
      // ----------------------------------------------------------------------
    ...
    PRIVATE:
      ...
      //! Stores the open serial port, POINTER_CAST so Linux and Nucleo may use different types
